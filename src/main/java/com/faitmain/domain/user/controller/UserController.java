...
//로그인 ajax로 바꾸면서 RestController 탐	   
	...
	public String addStore(@ModelAttribute("user") User user,
	...
	// public RedirectView kakaoLogin(@RequestParam(value = "code", required =
	// false) String code , RedirectAttributes model , HttpSession session) throws
	// Exception {
...
//getUser 유저 상세 
	@GetMapping("getUser")
	public String getUser(Model model, @RequestParam(value = "id", required = false) String id, HttpSession session,
